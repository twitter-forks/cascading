 ...
 * <p/>
 * Optionally diagnostic information may be captured along with the argument Tuple. Specifically:
 * <p/>
 * <ul>
 * <li>Element Trace - the file and line number the failed operation was instantiated</li>
 * <li>Throwable Message - the {@link Throwable#getMessage()} value</li>
 * <li>Throwable Stack Trace - the {@link Throwable#printStackTrace()} value, cleansed</li>
 * </ul>
 * <p/>
 ...
 * branch) should be part of the application. Traps capture the values that are missed and cause errors, if missing
 * them doesn't compromise the integrity of the application.
 */
