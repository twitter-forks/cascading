...
//    }
  ...
  public void testTrapDiagnostics() throws Exception
    ...
    Tap sink = getPlatform().getTextFile( getOutputPath( "diag/tap" ), SinkMode.REPLACE );
    Tap trap = getPlatform().getTabDelimitedFile( Fields.ALL, getOutputPath( "diag/trap" ), SinkMode.REPLACE );
  ...
  public void testTrapDiagnosticsLocalConfig() throws Exception
    ...
    Tap sink = getPlatform().getTextFile( getOutputPath( "diagconfigdef/tap" ), SinkMode.REPLACE );
    Tap trap = getPlatform().getTabDelimitedFile( Fields.ALL, getOutputPath( "diagconfigdef/trap" ), SinkMode.REPLACE );
